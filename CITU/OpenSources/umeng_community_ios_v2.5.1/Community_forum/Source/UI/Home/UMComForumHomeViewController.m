...
#define UMCom_Forum_Home_TopMenu_HighLightTextColor @"#FFFFFF"
#define UMCom_Forum_Home_DropMenu_NomalTextColor @"#F6F6F6"
...
//    [self createDiscoverView]; 暂时隐藏社区我的设置页面
...
- (void)createSubControllers
{
    ...
    segmentedControl.tintColor = COLOR_CITU_BROWN;
    segmentedControl.hidden = YES;
    [segmentedControl setfont:UMComFontNotoSansLightWithSafeSize(14) titleColor:COLOR_CITU_BROWN selectedColor:[UIColor whiteColor]];
    ...
    topiSegmentedControl.tintColor = COLOR_CITU_BROWN;
